...
behavior on every platform. Android default text/HTML paste consumes only the
first clipboard item; app-controlled paste can normalize multiple items. Pasted images continue through `onPasteImages`.
